  ...
  <main class="main">
    ...
    <div class="header">
      ...
      <div class="header-right">
        <a href="index.php" style="padding: 0.6rem 1.5rem; background: var(--green); color: white; border-radius: 0.5rem; cursor: pointer; font-size: 0.9rem; font-weight: 600; transition: all .3s; display: flex; align-items: center; gap: 0.5rem; text-decoration: none;" onmouseover="this.style.opacity='0.9'" onmouseout="this.style.opacity='1'">
          🏠 Home
        </a>
